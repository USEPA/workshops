...
- [Lesson 5 R Code](/introR/rmd_posts/2015-01-14-05-Explore.R): All the code from this post in an R Script.
...
2. Let's add another section to the script to create a pairs plot of the water quality data (TURB,NTL,PTL,CHLA, and SECMEAN).
