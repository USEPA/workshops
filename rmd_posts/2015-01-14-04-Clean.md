...
In the last lesson we focused on some basic cleaning operations (subsetting, merging, modifying, and summarizing) using base R.  I actually find myself still using these quite a bit.  That being said, I am slowly trying to make the switch to some of the packages that facilitate working with data frames, namely Hadley Wickham's `dplyr`. 

##Quick Links to Exercises and R code
- [Lesson 4 R Code](/introR/rmd_posts/2015-01-14-04-Clean.R): All the code from this post in an R Script.
