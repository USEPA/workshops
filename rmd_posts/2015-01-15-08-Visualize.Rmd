...
- [Lesson 8 R Code](/introR/rmd_posts/2015-01-14-08-Visualize.R): All the code from this post in an R Script.
...
In short, while some of the initial setup for ggplot is a bit more verbose that base R, but when we want to do some more complex plots it is much easier in `ggplot2`.  
...
There a few alternative themes available by default (use `help("ggtheme")`) that save some time and typing.  Let's look at two.
