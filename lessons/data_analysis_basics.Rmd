...
cor(log1p(nla_wq_subset[,6:10]))
#Spearman Rank Correlations
cor(log1p(nla_wq_subset[,6:10]),method = "spearman")
```
...
chla_tp_tn_turb <- lm(log1p(CHLA) ~ log1p(PTL) + log1p(NTL) + log1p(TURB), data = nla_wq_subset)
