...
pkgs <- c("sp","rgdal","rgeos","raster","knitr","quickmapr","leaflet")
...
- [ggplot2](https://cran.r-project.org/web/packages/ggplot2/index.html): THE data viz package for R.  Also can be used to make maps (it is what I use for my static maps). Requires additional processing of the spatial data to create plots, but has unlimited possibilities for creating maps.
