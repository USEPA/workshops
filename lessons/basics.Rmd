...
nca_url <- "https://raw.githubusercontent.com/USEPA/region7_r/master/nla_dat.csv"
nca_wq <- read.csv(nca_url,stringsAsFactors = FALSE)
head(nca_wq)
str(nca_wq)
dim(nca_wq)
summary(nca_wq)
