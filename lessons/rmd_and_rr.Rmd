...
- [`kdhe_markdown.Rmd`](https://raw.githubusercontent.com/jhollist/kdhe_region7_r/master/lessons/kdhe_markdown.Rmd)
- [`nla_2007_wq.csv`]()
- [`nla_2012_wq.csv`]()
...
With all of this in mind, let's jump into working with an R Markdown document (our `kdhe_markdown.Rmd`) and learn about the basic building blocks: YAML, Markdown, and Code Chunks.

## Create a Document
We will be working with the R Markdown document we already have, `kdhe_markdown.Rmd`, but for future reference to create your document, go to File: New File : R Markdown.  You should get a window that looks something like:
...
In our document, `kdhe_markdown.Rmd` we can see a couple of things.  In particular we see `YAML`, `Markdown`, text and code chunks.
