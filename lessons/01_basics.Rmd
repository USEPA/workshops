...
The basic syntax of function follows the form: `function_name(arg1, arg2, ...)`.  With the base install, you will gain access to many (`r length(unlist(sapply(search()[grep("package",search())],lsf.str)))`).  For instance:
