...
The select "Create Project."  At this point you should now have a new, empty project.  We need to download the R Markdown file we will be using for our workshop.  

- [Region 2 R Markdown Analysis](https:)
